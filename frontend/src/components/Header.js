      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between gap-4 h-16 sm:h-20">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="hidden lg:flex items-center gap-2 px-3 py-2 bg-[#F0EBE5] text-[#6A3512] rounded-xl border border-[#E6DCCF]">
        ...
        <div className="md:hidden pb-3">
          <div className="flex gap-2">
            ...
            <div className="flex items-center gap-1 px-3 py-2 bg-[#F0EBE5] text-[#6A3512] rounded-xl border border-[#E6DCCF] flex-shrink-0">
              <MapPin className="w-4 h-4" />
